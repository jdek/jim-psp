...
//John_K stuff that other things didn't have defined
...
static inline ogg_int32_t MULT32(ogg_int32_t x, ogg_int32_t y) {
  union magic_endian magic_endian;
  magic_endian.whole = (ogg_int64_t)x * y;
  return magic_endian.halves.hi;
}
...
static inline ogg_int32_t MULT31_SHIFT15(ogg_int32_t x, ogg_int32_t y) {
  union magic_endian magic_endian;
  magic_endian.whole  = (ogg_int64_t)x * y;
  return ((ogg_uint32_t)(magic_endian.halves.lo)>>15) | ((magic_endian.halves.hi)<<17);
}
